...
const sampleSurveys = [
  {
    ...
    GroupID: "A1",
    Questions: [
      { QuestionID: "Q1", QuestionText: "How would you rate the course?" },
      { QuestionID: "Q2", QuestionText: "What did you like most?" }
    ]
  },
  {
    SurveyID: "SURV2",
    ...
    GroupID: "A2",
    Questions: [
      { QuestionID: "Q3", QuestionText: "How would you rate the instructor?" },
      { QuestionID: "Q4", QuestionText: "What can be improved?" }
    ]
  }
]
